...
namespace FGAE
{
    public class Avoidin_B : FGAE_CharacterStateBase
    {
        ...
        {        
            ...
            {
                //if the spaceShip is within a range and he's not moving anymore, then it means the spaceShip is block. So he calculate a new point
            ...
            //Same thing here, but we have a timer for calculate just one time
